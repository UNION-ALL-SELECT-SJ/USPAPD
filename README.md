...
- Intakes data from the following protocol types:
  - serial: SPI, I2C, UART, FDCAN (compatible with BxCAN and CAN 2.0), USB (as device)
  - Parallel: 8, 16 or 32 bit bus
  - Analog
- Displays data on built in display, configurable to several formats
  - decimal and hexidecimal integers
  - single and double precision floating point
  - UTF-8 (this includes ASCII)
- Can remember up to 2000 individual bytes of data for browsing
- Graphing supported for numerical data


See Development journal for notes on development
